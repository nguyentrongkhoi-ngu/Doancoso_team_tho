        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-4 mt-6">
              <a href="https://www.facebook.com/nguyen.trong.khoi.433141" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-neutral-content/10 hover:bg-neutral-content/20 flex items-center justify-center transition-colors" aria-label="Facebook">
        ...
        <div className="container mx-auto py-6 px-4 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex items-center mt-4 md:mt-0">
            <div className="flex space-x-2 mt-4">
              <img src="https://via.placeholder.com/40x24?text=VISA" alt="Visa" className="h-6 rounded" />
              <img src="https://via.placeholder.com/40x24?text=MC" alt="Mastercard" className="h-6 rounded" />
              <img src="https://via.placeholder.com/40x24?text=PAYPAL" alt="PayPal" className="h-6 rounded" />
              <img src="https://via.placeholder.com/40x24?text=MOMO" alt="MoMo" className="h-6 rounded" />
            </div>
          </div>
        </div>
      </div>
