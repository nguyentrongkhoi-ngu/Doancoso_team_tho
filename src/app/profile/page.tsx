...
// Define UI states
type ProfileTab = 'info' | 'orders' | 'password' | 'wishlist' | 'viewed' | 'addresses' | 'account-settings';
...
export default function ProfilePage() {
  ...
  // For error handling in child components
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div className="card bg-base-100 shadow-sm border border-base-300">
            <div className="p-4 space-y-4">
              ...
              <button 
                ...
                className={`flex items-center p-3 rounded-lg text-left ${activeTab === 'orders' ? 'bg-primary text-primary-content' : 'hover:bg-base-200'}`}
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <button
                ...
                className={`flex items-center p-3 rounded-lg text-left ${activeTab === 'wishlist' ? 'bg-primary text-primary-content' : 'hover:bg-base-200'}`}
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <button
                ...
                className={`flex items-center p-3 rounded-lg text-left ${activeTab === 'viewed' ? 'bg-primary text-primary-content' : 'hover:bg-base-200'}`}
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <button
                ...
                className={`flex items-center p-3 rounded-lg text-left ${activeTab === 'addresses' ? 'bg-primary text-primary-content' : 'hover:bg-base-200'}`}
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <button
                ...
                className={`flex items-center p-3 rounded-lg text-left ${activeTab === 'account-settings' ? 'bg-primary text-primary-content' : 'hover:bg-base-200'}`}
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="md:col-span-3">
          <div className="bg-base-100 rounded-lg shadow p-6">
            ...
            {/* Wishlist Tab */}
            {activeTab === 'wishlist' && <WishlistSection onError={handleError} />}
            
            {/* Recently Viewed Products Tab */}
            {activeTab === 'viewed' && <RecentlyViewedSection onError={handleError} />}
            
            {/* Shipping Addresses Tab */}
            {activeTab === 'addresses' && <AddressesSection onError={handleError} />}
            ...
            {activeTab === 'account-settings' && <AccountSettingsSection onError={handleError} />}
          </div>
        </div>
      </div>
    </div>
