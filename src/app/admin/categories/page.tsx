...
import { FileEdit, Trash, AlertCircle, Info, Search, Plus, ImageIcon, Image as ImageComponent, Loader2, Upload, Download, FileJson, FileSpreadsheet, BarChart3, Star } from "lucide-react";
...
const CategoriesPage = () => {
  ...
  // Xử lý đánh dấu danh mục nổi bật
                    ...
                    <div className="flex items-center gap-4 flex-grow">
                      ...
                      <div className="flex-grow">
                        <div className="flex items-center gap-2">
                          ...
                          {category.isFeatured && (
                            <span className="bg-amber-100 text-amber-800 text-xs px-2 py-0.5 rounded-full flex items-center gap-0.5">
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                      ...
                      <div className="space-y-1 leading-none">
                        ...
                        <FormDescription>
                          Danh mục nổi bật sẽ hiển thị trong phần "Danh mục nổi bật" ở trang chủ
                        </FormDescription>
                      </div>
                    </FormItem>
                  )}
